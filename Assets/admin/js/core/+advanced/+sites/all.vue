<template>
    <v-card>
        ...
        <v-data-table
            ...
            <template slot="items" scope="props">
                ...
                <td v-if="eloquent_status == 'active'">
                    <v-btn small dark default outline router :to="{name: 'system.sites.edit', params: {id: props.item.id}}">
                        {{$t('table.edit')}}
                    </v-btn>
                    <v-btn small dark default outline router :to="{name: 'system.sites.config.index', params: {id: props.item.id}}">
                        {{$t('table.config')}}
                    </v-btn>
        ...
        <v-btn class="btn--add" dark primary floating router :to="{name: 'system.sites.create'}"  v-tooltip:left="{html: $t('system.sites.create')}">
...
<script type="text/babel">
    ...
    @Component
    export default class AllSites extends DataTables {
