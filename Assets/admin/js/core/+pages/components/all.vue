<template>
    <v-card>
        ...
        <v-data-table
            ...
            <template slot="items" scope="props">
                ...
                <td v-if="eloquent_status == 'active'">
                    <v-btn small dark default outline
                           router :to="{name: 'pages.edit', params: {id: props.item.id}}">
                        {{$t('table.edit')}}
                    </v-btn>
        ...
        <v-btn class="btn--add" dark primary floating router :to="{name: 'pages.add'}"  v-tooltip:left="{html: $t('pages.add')}">
...
<script type="text/babel">
    ...
    @Component
    export default class AllPages extends DataTables {
