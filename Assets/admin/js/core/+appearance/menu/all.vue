<template>
    <v-card>
        ...
        <v-data-table
            ...
            <template slot="items" scope="props">
                ...
                <td v-if="eloquent_status == 'active'">
                    <v-btn small dark default outline router :to="{name: 'appearance.menu.edit', params: {id: props.item.id}}">
                        {{$t('table.edit')}}
                    </v-btn>
        ...
        <v-btn class="btn--add" dark primary floating router :to="{name: 'appearance.menu.create'}"  v-tooltip:left="{html: $t('appearance.menu.create')}">
...
<script type="text/babel">
    ...
    @Component
    export default class AllMenus extends DataTables {
